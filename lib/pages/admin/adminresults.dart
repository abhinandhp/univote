...
import 'package:univote/pages/admin/adminresultdetails.dart';
...
class _AdminResultPageState extends State<AdminResultPage> {
  ...
  void _refreshElections() {
    setState(() {
      _electionFuture = _electionService.adminfetchCompletedElections();
    });
  }
                     ...
                     return GestureDetector(
                      onTap: () {
                        PersistentNavBarNavigator.pushNewScreen(
                          context,
                          screen: AdminResultDetailsPage(election: election),
                          withNavBar: false,
