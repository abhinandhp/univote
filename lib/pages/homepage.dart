            ...
            SizedBox(
              ...
              child: StreamBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  return SizedBox(
                    height: 630, // Set an appropriate height for your list
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => AdminElectionDetails(elec: election),
                                        ),
                                      );
                                    },
...
// Placeholder for the voting page
class VotingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Voting page for election: $electionId'),
      ),
    );
  }
}